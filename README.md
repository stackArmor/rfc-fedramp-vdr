...
| [`internet-accessibility.tex`](internet-accessibility.tex) | [PDF](https://stackarmor.github.io/rfc-fedramp-vdr/internet-accessibility.pdf) | **Companion proposal.** *An Exclusion-Gated Method for Defining Resource Internet Reachability for FedRAMP Rev5 VDR/VER* — details a systematic, logical 5-gate pipeline (IP routing, network firewall limits, edge auth layers, Kubernetes ingress/Gateway API configs, and process-to-port automation) to define and exclude resources from internet-reachability, and addresses WAF mitigation VEX attestations. |
...
tectonic internet-accessibility.tex # -> internet-accessibility.pdf
```
