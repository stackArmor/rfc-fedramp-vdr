...
The chained-access branch for downstream finding $(v,a)$ is
...
Thus, an active upstream finding must itself match a public network surface,
not merely carry an \code{AV:N} vector. The downstream finding remains
