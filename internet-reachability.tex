...
Equation~\ref{eq:fullinfo} then asks two independent questions:
...
least one match exists,'' and $\lor$ means ``or.'' If either the direct-network
comparison or the carried-content comparison has a match, the finding is IRV.
...
prevention assertion $P_0(v,a)$. The full-information form shows how richer
metadata could improve precision later; it does not make a complete data-flow
