...
\item \textbf{Internet-reachability counts edge authentication as a mitigation.} We
  ...
  attacker cannot reach the vulnerable surface. This approach is conceptually 
  similar to requiring a virtual private network (VPN) or secure tunnel to access 
  a resource.
