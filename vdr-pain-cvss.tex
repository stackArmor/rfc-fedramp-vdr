...
\item \textbf{Governed asset inputs.} An asset needs an uncapped
  security-impact profile and an affected-agency scope. The profile may be assigned
  directly or resolved from governed metadata such as an archetype; the
  intended-use ceiling is resolved separately.
