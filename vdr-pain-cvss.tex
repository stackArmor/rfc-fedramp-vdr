...
worked cases are specified in the companion paper \emph{A Scalable
Trigger-Metadata Model for Internet Reachability under the FedRAMP VDR/VER Rules}.
\end{definitionbox}
...
\item[{[EGR]}] M.~Venne, \emph{A Scalable Trigger-Metadata Model for Internet
  Reachability under the FedRAMP VDR/VER Rules}, stackArmor,
