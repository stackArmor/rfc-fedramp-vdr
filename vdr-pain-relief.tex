...
firewall's, expressed as tiers: an IP/port allow-list earns $\rho\approx0.90$;
SNI filtering without DNS validation, $0.80$; SNI with DNS validation, $0.70$; and
outbound break-and-inspect --- which decrypts and checks the Host header, catching
domain fronting --- $0.50$. \emph{But Log4Shell is a KEV}, so by default it is
