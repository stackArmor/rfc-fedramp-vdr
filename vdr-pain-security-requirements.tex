...
Applying it can reduce an archetype requirement that exceeds the consequence
supported by the agency's intended use; it cannot raise a low-role asset merely
because the system contains more sensitive information. The uncapped archetype
continues to describe the reusable role, while the effective vector describes that
role in this system and agency context.
