...
\date{July 2026\\\small Version 1.5}
...
therefore not a data-eligibility label, FIPS~199 category, or impact ceiling. The
Low/Moderate/High Class shorthand is useful only as a planning approximation.
...
Certification Class does not change that PAIN word. It selects the standard level
of assurance and operational timeframes applied after consequence and affected
scope have been derived. Providers may govern different PAIN calibrations, but any
different thresholds or predicates must be disclosed as policy choices rather than
attributed to FIPS~199, NIST SP~800-60, or Certification Class.
