...
\item \textnormal{Remote-access boundary authentication: the edge rejects unauthenticated traffic \emph{and} its declared, assessor-validated role is remote access for the organization's own people and tooling (not customer authentication for the service).}
