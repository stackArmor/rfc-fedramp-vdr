...
\item \textbf{Is it actually being exploited --- or likely to be?} This is the
  ...
  The method also applies a direct-exposure floor: a directly internet-reachable
  finding with \texttt{AV:N/AC:L/PR:N/UI:N} is treated as likely exploitable. Whichever
  predicate fires moves the finding to a faster remediation column.
